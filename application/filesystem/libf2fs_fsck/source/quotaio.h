 ...
 * filesystem. */
errcode_t quota_file_open(fsck_f2fs_sb_info *sbi, struct quota_handle *h,
			  enum quota_type qtype, int flags);

/* Create new quotafile of specified format on given filesystem */
errcode_t quota_file_create(fsck_f2fs_sb_info *sbi, struct quota_handle *h,
		enum quota_type qtype);

/* Close quotafile */
errcode_t quota_file_close(fsck_f2fs_sb_info *sbi, struct quota_handle *h,
		int update_filesize);
...
/* In mkquota.c */
errcode_t quota_init_context(fsck_f2fs_sb_info *sbi);
void quota_data_inodes(quota_ctx_t qctx, f2fs_inode *inode, int adjust);
void quota_data_add(quota_ctx_t qctx, f2fs_inode *inode, qsize_t space);
void quota_data_sub(quota_ctx_t qctx, f2fs_inode *inode, qsize_t space);
errcode_t quota_write_inode(fsck_f2fs_sb_info *sbi, enum quota_type qtype);
void quota_add_inode_usage(quota_ctx_t qctx, f2fs_ino_t ino,
		f2fs_inode* inode);
void quota_release_context(quota_ctx_t *qctx);
errcode_t quota_compare_and_update(fsck_f2fs_sb_info *sbi,
