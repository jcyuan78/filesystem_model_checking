...
int inode_newsize_ok(const inode *iinode, loff_t offset)
{
	if (iinode->i_size < offset) 
	{
//		unsigned long limit;
//		limit = rlimit(RLIMIT_FSIZE);
//		if (limit != RLIM_INFINITY && offset > limit) 		goto out_sig;
		if (offset > iinode->i_sb->s_maxbytes)			goto out_big;
	} 
	else
	{
