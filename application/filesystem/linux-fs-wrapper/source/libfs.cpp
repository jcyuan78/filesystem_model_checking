...
static  struct dentry_operations generic_ci_dentry_ops;
//= {
...
void generic_set_encrypted_ci_d_ops(struct dentry *dentry)
{
	...
	if (needs_ci_ops) 
	{
		generic_ci_dentry_ops.d_hash = generic_ci_d_hash;
		generic_ci_dentry_ops.d_compare = generic_ci_d_compare;
