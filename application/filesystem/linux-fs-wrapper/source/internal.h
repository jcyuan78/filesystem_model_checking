...
extern int __sync_blockdev(block_device *bdev, int wait);
void iterate_bdevs(void (*)(block_device *, void *), void *);
...
static inline int __sync_blockdev(block_device *bdev, int wait)
{
	return 0;
}
static inline void iterate_bdevs(void (*f)(block_device *, void *),
		void *arg)
{
}
