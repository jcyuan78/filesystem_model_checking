...
{
	static struct rb_augment_callbacks dummy_callbacks;
	dummy_callbacks.propagate = dummy_propagate;
	dummy_callbacks.copy = dummy_copy;
	dummy_callbacks.rotate = dummy_rotate;
