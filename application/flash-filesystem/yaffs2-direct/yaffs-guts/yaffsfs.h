...
int yaffs_getxattr(const YCHAR *path, const YCHAR *name,
			void *data, int size);
int yaffs_lgetxattr(const YCHAR *path, const YCHAR *name,
			void *data, int size);
int yaffs_fgetxattr(int fd, const YCHAR *name,
			void *data, int size);
...
int yaffs_listxattr(const YCHAR *path, YCHAR *list, int size);
int yaffs_llistxattr(const YCHAR *path, YCHAR *list, int size);
int yaffs_flistxattr(int fd, YCHAR *list, int size);
...
const YCHAR *yaffs_error_to_str(int err);
